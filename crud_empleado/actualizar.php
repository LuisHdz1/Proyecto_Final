    ...
    <body>
                <div class="container mt-5">
                    ...
                    <p>Después de actualizar recargar la página</p>
                                <input type="hidden" class="form-control mb-3" name="id" placeholder="id" value="<?php echo $row['Nombre']  ?>"> 
                                <input type="text" class="form-control mb-3" name="Nombre" placeholder="Nombre" value="<?php echo $row['Nombre']  ?>">
                                <input type="text" class="form-control mb-3" name="ApellidoPaterno" placeholder="ApellidoPaterno" value="<?php echo $row['ApellidoPaterno']  ?>">
                                <input type="text" class="form-control mb-3" name="ApellidoMaterno" placeholder="ApellidoMaterno" value="<?php echo $row['ApellidoMaterno']  ?>">
