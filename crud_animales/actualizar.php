...
$sql="SELECT * FROM animales WHERE Nombre='$id'";
    ...
    <body>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                                ...
                                <input type="text" class="form-control mb-3" name="Temperatura" placeholder="Temperatura" value="<?php echo $row['Temperatura']  ?>">
